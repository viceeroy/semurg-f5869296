...
import { Settings, Grid3X3, Bookmark, MapPin, Calendar, Edit, LogOut, UserPlus, Users, Award } from "lucide-react";
...
const ProfilePage = ({ profileData, onEditProfile }: ProfilePageProps) => {
  ...
  const { badges, loading: badgesLoading, getBadgeName, getBadgeDescription } = useBadges();
              ...
              {suggestedUsers.length > 0 && (
                <div className="space-y-3">
                  {suggestedUsers.map((suggestedUser) => (
                    <div key={suggestedUser.id} className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded">
                      <div className="flex items-center space-x-3">
                        <AvatarFallback
                          src={suggestedUser.avatar_url}
                          name={suggestedUser.first_name && suggestedUser.last_name 
                      ...
                      <Button
                        ...
                        onClick={() => followUser(suggestedUser.id)}
                        disabled={followsLoading}
                        className="bg-emerald-600 hover:bg-emerald-700 rounded"
                      >
